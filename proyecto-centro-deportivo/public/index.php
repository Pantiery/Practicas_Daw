...
<section class="container fondo-card-hero-principal my-5">
    ...
    <div class="row">
        ...
        <?php
        $imagen = "../assets/img/logo-asociados/asociacion_pensionistas.png";
        ...
        <?php
        $imagen = "../assets/img/logo-asociados/logo-ADFerroviaria-5.png";
        ...
        <?php
        $imagen = "../assets/img/logo-asociados/Logo_Turisfer_Asoc_Turistica_Ferroviaria_60anios_2023.png";
